...
static PyObject *impl_numpy$lib$shape_base$$$function__7_apply_along_axis(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    try_end_1:;
    {
...

        {
            ...
            tmp_args_element_value_7 = impl___main__$$$function__13_complex_call_helper_pos_star_list_star_dict(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_args_element_value_11 = impl___main__$$$function__13_complex_call_helper_pos_star_list_star_dict(dir_call_args);
        }
